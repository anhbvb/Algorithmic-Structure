...
// Hàm để thêm phần tử x vào sau phần tử y trong danh sách liên kết
...
int main() {
    ...
    scanf("%d", &x);
    printf("Nhap gia tri y sau do can them: ");
    scanf("%d", &y);

    head = insertAfter(head, x, y);

    printf("Danh sach sau khi them phan tu %d sau phan tu %d: ", x, y);
    printList(head);
